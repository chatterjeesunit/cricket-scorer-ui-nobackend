...
import { updateStatus, updateRuns, updateBalls, updatePlayer } from '../utils/gameHelper';
      ...
      const obj = {
        ...
        team1: {
          ...
          players: state.team1.isBatting ?
            updateStatus(state.team1.players, action.batsmanId, PlayerStatus.STRIKER) :
            state.team1.players,
        },
        team2: {
          ...state.team2,
          players: state.team2.isBatting ?
            updateStatus(state.team2.players, action.batsmanId, PlayerStatus.STRIKER) :
            state.team2.players,
        },
      };
